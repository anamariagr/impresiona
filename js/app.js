...
const PRODUCT_TYPES = [
 ...
 { key: "bolsos", label: "Bolsos / Totebags", icon: "shopping_bag" },
  { key: "combos", label: "Combos de regalo", icon: "card_giftcard", image: "./img/combo-calcifer.jpg" },
  ...
  { key: "termos", label: "Termos / Botilitos", icon: "thermostat", image: "./img/termo-mafalda.jpg" },
...
const SEED_PRODUCTS = [
  ...
  },
 {
  ...
  },
  {
    ...
    clientType: "personas",
    price: "$150.000",
    desc: "Combo de regalo personalizado con diseño de Calcifer.",
    image: "./img/combo-calcifer.jpg",
    custom: true,
  },
  {
    id: "p32",
    ...
    clientType: "personas",
    price: "$150.000",
    desc: "Combo de regalo personalizado con diseño de Doraemon.",
    image: "./img/combo-doraimon.jpg",
    custom: true,
  },
  {
    id: "p33",
    ...
    clientType: "personas",
    price: "$150.000",
    desc: "Combo de regalo personalizado con diseño de Garfield.",
    image: "./img/combo-garfield.jpg",
    custom: true,
  },
  {
    id: "p34",
    name: "Combo Hora de Aventura",
    type: "combos",
    month: "diciembre",
    clientType: "personas",
    price: "$150.000",
    desc: "Combo de regalo personalizado con diseño de Hora de Aventura.",
    image: "./img/combo-horadeaventura.jpg",
    custom: true,
  },
  {
    id: "p35",
    ...
    clientType: "personas",
    price: "$150.000",
    desc: "Combo de regalo personalizado con diseño de Lulú.",
    image: "./img/combo-lulu.jpg",
    custom: true,
  },
  {
    id: "p36",
    name: "Combo El Principito",
    type: "combos",
    month: "diciembre",
    clientType: "personas",
    price: "$150.000",
    desc: "Combo de regalo personalizado con diseño de El Principito.",
    image: "./img/combo-principito.jpg",
    custom: true,
  },
  {
    id: "p37",
    ...
    clientType: "personas",
    price: "$150.000",
    desc: "Combo de regalo personalizado con diseño de Snoopy.",
    image: "./img/combo-snoopy.jpg",
    custom: true,
  },
  {
    id: "p38",
    ...
    clientType: "personas",
    price: "$150.000",
    desc: "Combo de regalo personalizado con diseño de Totoro.",
    image: "./img/combo-totoro.jpg",
    custom: true,
  },
  {
    id: "p39",
    ...
    clientType: "personas",
    price: "$35.000",
    desc: "Botilito térmico personalizado con diseño de Garfield.",
    image: "./img/termogarfield.jpg",
    custom: true,
  },
  {
    id: "p40",
    name: "Termo Hora de Aventura",
    type: "termos",
    month: "diciembre",
    clientType: "personas",
    price: "$35.000",
    desc: "Botilito térmico personalizado con diseño de Hora de Aventura.",
    image: "./img/termo-horadeaventura.jpg",
    custom: true,
  },
  {
    id: "p41",
    ...
    clientType: "personas",
    price: "$35.000",
    desc: "Botilito térmico personalizado con diseño de Mafalda.",
    image: "./img/termo-mafalda.jpg",
    custom: true,
  },
  {
    id: "p42",
    ...
    clientType: "personas",
    price: "$35.000",
    desc: "Botilito térmico personalizado con diseño de Coraje, el perro cobarde.",
    image: "./img/termo-perrocoraje.jpg",
    custom: true,
  },
  {
    id: "p43",
    name: "Termo El Principito",
    type: "termos",
    month: "diciembre",
    clientType: "personas",
    price: "$35.000",
    desc: "Botilito térmico personalizado con diseño de El Principito.",
    image: "./img/termoprincipito.jpg",
    custom: true,
  },
  {
    id: "p44",
    name: "Combo Frankenstein",
    type: "combos",
    month: "diciembre",
    clientType: "personas",
    price: "$150.000",
    desc: "Combo de regalo con gorro, taza, medias y pin de Frankenstein.",
    image: "./img/combo-frankenstain.jpg",
    custom: true,
  },
  {
    id: "p45",
    name: "Combo Calcifer edición gorro",
    type: "combos",
    month: "diciembre",
    clientType: "personas",
    price: "$150.000",
    desc: "Combo de regalo con gorro, taza, medias y pin de Calcifer.",
    image: "./img/combo-calcifer-2.jpg",
    custom: true,
  },
  {
    id: "p46",
    name: "Combo Totoro & Friends",
    type: "combos",
    month: "diciembre",
    clientType: "personas",
    price: "$150.000",
    desc: "Combo de regalo con gorro, taza, llavero y pin de Totoro.",
    image: "./img/combo-totoro2.jpg",
    custom: true,
  },
  {
    id: "p47",
    name: "Combo Snoopy verano",
    type: "combos",
    month: "diciembre",
    clientType: "personas",
    price: "$150.000",
    desc: "Combo de regalo con gorro, taza, llavero y pin de Snoopy.",
    image: "./img/combo-snoopy-verano.jpg",
    custom: true,
  },
